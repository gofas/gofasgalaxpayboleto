...
function gofasgalaxpayboleto_config(){
	...
	$check_updates = ggpb_verify_module_updates('14695',$whmcs_url['url']['url'],$module_version);
	...
	$renderize = array(
		...
		'separator_1' => array(
			...
			<div class="ggpc_separator" style="padding: 1px 15px 9px;">
				...
				<iframe frameborder="0" width="300" height="150" src="https://gofas.net/cliente/gofas/updates/?embed=14695"></iframe>
				</div>
